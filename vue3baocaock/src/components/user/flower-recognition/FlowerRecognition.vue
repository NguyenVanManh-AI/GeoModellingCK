<template>
    <div class="account_setting">
        <form class="col-12" @submit.prevent="updateProfile">
            <div class="row">
                <div class="colorTitle"><i class="fa-solid fa-fan"></i> Flower Recognition</div>
            </div>
            <div class="contact-info">
                ...
                <div class="col-6">
                    <div class="row colorTitle bigTitle"><span><i class="fa-solid fa-tag"></i> Flowers Name</span></div>
                    <div class="row mt-3">
                        <div class="col-12">
                            <input class="form-control" readonly v-model="flowers_name" placeholder="Flowers Name"
                                type="text">
                        </div>
                    </div>
                </div>
...
export default {
    ...
    async mounted() {
        ...
        this.previewImageSrc = this.flowers_image;
    ...
    methods: {
        ...
        updateProfile: async function () { // (1)
            try {
                ...
                if (this.updateImage) {
                    formData.append('image_input', this.flowers_image);
                }
                const { data, messages } = await ModelRequest.post('flower', formData, true);
                this.flowers_name = data.flowers_name;
                this.updateImage = false;
